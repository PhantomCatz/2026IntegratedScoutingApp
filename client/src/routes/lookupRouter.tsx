...
function LookupRouter(props: Props): React.ReactElement {
	...
	return (
		<>
			...
			<lookup-router>
				<a className="mainButton" href="#scoutingapp/lookup/match">
					Match
				</a>
				<a className="mainButton" href="#scoutingapp/lookup/strategic">
					Strategic
				</a>
				<a className="mainButton" href="#scoutingapp/lookup/pit">
					Pit
				</a>
			</lookup-router>
		</>
